package com.jinxiu.malltestplus.generator;
...
public class MyBatisPlusGenerator {
    ...
    private static GlobalConfig initGlobalConfig(String projectPath){
        ...
        globalConfig.setXmlName("%sService");
        globalConfig.setServiceName("%sService");
        globalConfig.setServiceImplName("%Controller");
        return globalConfig;
    }
     ...
     * 初始化数据源配置
     */
    private static DataSourceConfig initDateSourceConfig(){
